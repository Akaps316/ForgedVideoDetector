...
FILE_REF = ['C:\Users\Akaps\Desktop\MAT\output2\img_' num2str(round(rand()*1e7)) num2str(round(rand()*1e7)) '.jpg']; % temporary reference image
while exist(FILE_REF,'file'), FILE_REF = ['C:\Users\Akaps\Desktop\MAT\output2\img_' num2str(round(rand()*1e7)) num2str(round(rand()*1e7)) '.jpg']; end
