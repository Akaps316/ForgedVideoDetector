...
for vidcount=11:11
    if vidcount ~= 10
        vid = num2str(vidcount);
    end

    vidObj = VideoReader(['C:\Users\Akaps\Desktop\MAT\videos\h264_lossy_q10\' vid '_original_enc10.avi']);
    ...
    for i=1:numImgs-1
        ...
        imwrite(R(i).cdata,['C:\Users\Akaps\Desktop\MAT\output\' num2str(vidcount) '\' num2str(i) '.jpg'], 'JPEG');
        if mod(i,9) == 1 || mod(i,9) == 4 || mod(i,9) == 7
            F = ccpev548(['C:\Users\Akaps\Desktop\MAT\output\' num2str(vidcount) '\' num2str(i) '.jpg'],75);
            for j=1:548
                d(indexes,j) = F(j);
            end
...
save C:\Users\Akaps\Desktop\MAT\cover.mat d names -v7.3;
