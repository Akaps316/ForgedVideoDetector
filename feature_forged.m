...
for vidcount=1:1
    ...
    vidObj = VideoReader(['C:\Users\Akaps\Desktop\MAT\videos\h264_lossy_q10\' vid '_forged_enc10.avi']);
    ...
    for i=1:numImgs-1
        ...
        imwrite(R(i).cdata,['C:\Users\Akaps\Desktop\MAT\output2\' num2str(vidcount) '\' num2str(i) '.jpg'], 'JPEG');
        if mod(i,9) == 1 || mod(i,9) == 4 || mod(i,9) == 7
            F = ccpev548(['C:\Users\Akaps\Desktop\MAT\output2\' num2str(vidcount) '\' num2str(i) '.jpg'],75);
            for j=1:548
                d(indexes,j) = F(j);
            end
...
save C:\Users\Akaps\Desktop\MAT\stego.mat d names -v7.3;